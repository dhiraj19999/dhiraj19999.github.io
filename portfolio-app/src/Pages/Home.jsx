    ...
    <Container maxW={"7xl"} className={styles.home}>
      ...
      >
        <Stack flex={1} spacing={{ base: 5, md: 10 }}>
          ...
          >
            <Text fontSize={{ base: "3xl", sm: "3xl", md: "3xl", lg: "5xl" }}>
              Hello, I'm
            </Text>
            <Text
              color={"#20B2AA"}
          ...
          <Text>
            A passionate Full Stack Web Developer, love to developing scalable
            websites using a wide range of front-end and back-end skills
          </Text>
          <Stack
            spacing={{ base: 4, sm: 6 }}
