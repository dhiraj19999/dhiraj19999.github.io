        ...
        <Flex h={20} alignItems={"center"} justifyContent={"space-between"}>
          ...
          <HStack spacing={8} alignItems={"center"}>
            <Avatar
              size={"lg"}
              src={
                "https://st3.depositphotos.com/4263287/14721/v/600/depositphotos_147213525-stock-illustration-dg-d-g-pink-purple.jpg"
              }
              ...
              >
                ...
                <div>
                  <Button
                    onClick={() => {
                      window.open(
                        "https://drive.google.com/file/d/10-uBV0jzx3SvZX4gKHblohPqq9hjpvtT/view?usp=sharing",
                        "_blank"
                      );
                    }}
                    rounded={"full"}
        ...
        {isOpen ? (
          <Box pb={4} display={{ md: "none" }}>
            <Stack as={"nav"} spacing={4}>
              ...
              <NavLink>
                <div onClick={skilClick}>Skills</div>
              </NavLink>
              <NavLink>
                <div onClick={contactClick}>Contacts</div>
              </NavLink>
              <NavLink>
                <a href="https://drive.google.com/u/0/uc?id=1FAQZD0ZtN8JYVDEbV8smXClFaDYp2Muy&export=download">
                  Resume
                </a>
              </NavLink>
            </Stack>
